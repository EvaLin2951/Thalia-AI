...
# Initialize rag_chain as None
rag_chain = None

if not gemini_api_key:
    print("Warning: GOOGLE_API_KEY environment variable not set.")
    print("RAG/AI chat functionality will be unavailable. App will continue to run.")
    rag_chain = None

    # Define dummy function for compatibility
    def test_rag_sql_output():
        print("RAG chain not available - GOOGLE_API_KEY not set")
else:
    # API key available, continue with initialization
    ...
    _continue_init = True  # Flag to control initialization flow
    ...
    try:
        ...
        print("RAG chain will be unavailable.")
        _continue_init = False

    if _continue_init:  # Only continue if no errors so far
